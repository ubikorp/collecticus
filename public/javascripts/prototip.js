...
// Modified for Collectic.us 'bubble' by nap, 08.11.07
...
Tip.prototype = {
  ...
  buildTip: function() {
    ...
    // add the bubble top
    this.top = this.tooltip.appendChild(document.createElement('div'));
    ...
    if (this.options.thumbnail) {
      this.thumbnail = this.tip.appendChild(document.createElement('img'));
      this.thumbnail.className = 'thumbnail';
      this.thumbnail.src = this.options.thumbnail;
    }
    
    this.tipbody = this.tip.appendChild(document.createElement('div'));
    Element.update(this.tipbody, this.content);
    this.cleardiv = this.tip.appendChild(document.createElement('div'));
    this.cleardiv.className = 'clear';
    
    // add the bubble bottom
    this.bottom = this.tooltip.appendChild(document.createElement('div'));
